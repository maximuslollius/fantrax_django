...
def call_gameweeks(first_gameweek, last_gameweek):
    ...
    import os
    placeholder_dir = os.path.join(os.getcwd(), 'core', 'fixtures', 'gameweeks')
    ...
    GW_26 = pd.read_csv(placeholder_dir + "/GW_26.csv")
    GW_27 = pd.read_csv(placeholder_dir + "/GW_27.csv")
    GW_28 = pd.read_csv(placeholder_dir + "/GW_28.csv")
    GW_29 = pd.read_csv(placeholder_dir + "/GW_29.csv")
    ...
    gameweeks = {'GW_01': GW_01, 'GW_02': GW_02, 'GW_03': GW_03, 'GW_04': GW_04, 'GW_05': GW_05, 'GW_06': GW_06,
                 ...
                 'GW_25': GW_25, 'GW_26': GW_26, 'GW_27': GW_27, 'GW_28': GW_28, 'GW_29': GW_29}
    ...
    gw_to_ints = {'1': 'GW_01', '2':'GW_02', '3':'GW_03', '4':'GW_04', '5':'GW_05', '6':'GW_06',
                 ...
                 '25':'GW_25', '26':'GW_26', '27':'GW_27', '28':'GW_28', '29':'GW_29'}
